  ...
  <body>
    ...
    <div class="contenaire">
        ...
        <label for="id">Identifiant :
          <?php if($_GET['err'] =='id' || $_GET['err'] =='tw'){
            echo '<span style="color:black">erreur identifiant</span>';
          }?>
        </label><br/>
        <input class="form-control" type="text" id="id" name="id" autocomplete="off"><br/>
        <label for="password">Mot de passe :
          <?php if($_GET['err'] =='pw' || $_GET['err'] =='tw'){
            echo '<span style="color:black">erreur mot de passe</span>';
          }?>
        </label><br/>
